...
function SettingsPage({ business, setBusiness }: { business: BusinessProfile; setBusiness: (business:BusinessProfile)=>void }) {
  ...
  const tabs=["Profil bisnis","Kasir & printer","Outlet","Produksi","Persediaan","PIN owner","Operator"];
  ...
  return <>
    ...
    <main className="content settings-page">
      ...
      <section className="panel settings-content">
        ...
        {tab==="Produksi" && <><div className="settings-title"><h2>Produksi</h2><p>Aturan standar batch dan deep fryer.</p></div><div className="setting-field"><label>Ukuran batch default</label><select><option>2 pak ayam</option><option>1 pak ayam</option></select></div><div className="setting-field"><label>Rasio tepung</label><input defaultValue="1 pak tepung / 3 pak ayam"/></div><div className="setting-field"><label>Pengisian awal fryer</label><input defaultValue="7 pouch · 14 liter"/></div><div className="setting-field"><label>Pengingat top-up</label><input defaultValue="Setiap 10 pak ayam"/></div><div className="setting-field"><label>Batas pergantian</label><input defaultValue="200 pak atau 21 hari"/></div><div className="setting-row"><div><strong>Blokir produksi saat minyak lewat batas</strong><span>Dapat dilanjutkan dengan PIN owner.</span></div><button className="switch on"><i/></button></div></>}
        {tab==="Persediaan" && <><div className="settings-title"><h2>Persediaan</h2><p>Aturan stok dan pencatatan bahan.</p></div><div className="setting-row"><div><strong>Cegah stok negatif</strong><span>Item dengan stok nol tidak dapat digunakan.</span></div><button className="switch on"><i/></button></div><div className="setting-row"><div><strong>Peringatan stok minimum</strong><span>Tampilkan notifikasi di ringkasan.</span></div><button className="switch on"><i/></button></div><div className="setting-field"><label>Metode penggunaan batch</label><select><option>FIFO · batch tertua dahulu</option><option>Manual</option></select></div><div className="setting-field"><label>Jadwal stock opname</label><select><option>Setiap tutup outlet</option><option>Mingguan</option></select></div><div className="dummy-note"><Boxes/><div><strong>3 item menipis</strong><span>Tepung, saus sachet, dan kemasan rice bowl.</span></div></div></>}
