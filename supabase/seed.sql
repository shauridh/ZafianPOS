-- Development-only seed. Replace IDs and credentials through the bootstrap script in production.
insert into public.outlets (id, name, timezone)
values ('00000000-0000-0000-0000-000000000001', 'Outlet Utama', 'Asia/Jakarta')
on conflict do nothing;

insert into public.business_settings (outlet_id, business_name, tagline)
values ('00000000-0000-0000-0000-000000000001', 'Sabana', 'Operation Hub')
on conflict do nothing;
